...
begin
      ...
      dtmServidor.qryUpdate.Params.ParamByName('Cod_Lar').AsString := IntToStr(iCodigoLar); //INSERIR CÓDIGO DO ANIMAL
      ...
      dtmServidor.qryGeral.SQL.Text := ' SELECT * FROM LarTemporario WHERE COD_LAR = '+IntToStr(iCodigoLar); //INSERIR CÓDIGO DO ANIMAL
