...
type
  TLoading = class
    ...
    public
          ...
          class procedure ToastMessage(const Frm : Tform; const msg: string; cor_fundo: Cardinal;
...
class procedure TLoading.ToastMessage(const Frm : Tform; const msg: string; cor_fundo: Cardinal;
                                      alinhamento: TAlignLayout;
                                      //cor_fundo: Cardinal = $FF22AF70;
                                      cor_fonte: Cardinal = $FFFFFFFF;
                                      duracao: integer = 4);
